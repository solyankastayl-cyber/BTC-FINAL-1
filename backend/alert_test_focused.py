...
class AlertAPITester:
    def __init__(self, base_url: str = "https://fractal-ui-upgrade.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing backend at: https://fractal-ui-upgrade.preview.emergentagent.com")
